...
(defconst feature-font-lock-keywords
  (list
   ...
   '("^ *Antecedentes:$" (0 font-lock-keyword-face))
   '("^ *Scenario\\(?: Outline\\)?:" (0 font-lock-keyword-face) (".*" nil nil (0 font-lock-function-name-face t)))
   '("^ *Escenario:" (0 font-lock-keyword-face) (".*" nil nil (0 font-lock-function-name-face t)))
   '("^ *Esquema del escenario:" (0 font-lock-keyword-face) (".*" nil nil (0 font-lock-function-name-face t)))
   '("^ *Given" . font-lock-keyword-face)
   '("^ *Dado" . font-lock-keyword-face)
   '("^ *When" . font-lock-keyword-face)
   '("^ *Cuando" . font-lock-keyword-face)
   '("^ *Then" . font-lock-keyword-face)
   '("^ *Entonces" . font-lock-keyword-face)
   '("^ *But" . font-lock-keyword-face)
   '("^ *Pero" . font-lock-keyword-face)
   '("^ *And" . font-lock-keyword-face)
   '("^ *Y" . font-lock-keyword-face)
   '("^ *@.*" . font-lock-preprocessor-face)
   '("^ *\\(?:More \\)?Examples:" . font-lock-keyword-face)
   '("^ *Ejemplos:" . font-lock-keyword-face)
